...
app.use(helmet());
app.use(cors({ origin: (origin, callback) => !origin || allowedOrigins.length === 0 || allowedOrigins.includes(origin) ? callback(null, true) : callback(new Error('CORS origin denied')), credentials: true }));
