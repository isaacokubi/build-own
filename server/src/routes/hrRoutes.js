...
r.get('/leave',listLeaves);r.post('/leave',requireRole(...supervisors),createLeave);r.patch('/leave/:id/approval',requireRole(...managers),approveLeave);
r.get('/timesheets',listTimesheets);r.post('/timesheets',requireRole(...supervisors),createTimesheet);
export default r;
